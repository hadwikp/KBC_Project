...
class KbcAppTestCase(unittest.TestCase):
    ...
    @patch('app.mysql')
    def test_select_user(self, mock_mysql):
...
class KbcQuestionsTestCase(unittest.TestCase):
    ...
    def test_insert_questions(self, mock_file, mock_cnx):
        # Create a dummy connection and cursor to simulate MySQL operations.
        ...
        # Patch the module-level connection in questions.py
        import questions
        questions.cnx = dummy_connection

        # Call the function to insert questions
        questions.insert_questions('dummy.json')
